        ...
        <Layout>
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <div className="text-gray-500">コンテンツ一覧を読み込み中...</div>
            </div>
          </div>
        </Layout>
      </ProtectedRoute>
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-medium text-gray-900">コンテンツ一覧</h2>
            ...
            {videos.length === 0 ? (
              <div className="px-6 py-12 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {isShopAdmin ? 'コンテンツが登録されていません' : 'コンテンツが登録されていません'}
                </h3>
                <p className="text-gray-600 mb-4">
                  {isShopAdmin ? 'あなたの販売店のコンテンツをアップロードしてください。' : '新しいコンテンツをアップロードしてください。'}
                </p>
                <button
                  onClick={() => router.push('/upload')}
                  className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {videos.map((video) => (
                      <tr key={video.videoId} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${video.status === 'completed'
